...
\renewcommand{\cftchapaftersnumb}{.} % Add dot after chapter number in TOC
...
\renewcommand{\cftsecaftersnumb}{.} % Add dot after section number in TOC
...
\renewcommand{\cftsubsecaftersnumb}{.} % Add dot after subsection number in TOC

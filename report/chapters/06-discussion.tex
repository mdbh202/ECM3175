...
shell structure. The mechanical advantage of high-modulus shells is conceptualised as a ``snowshoe effect'', where the stiff shell prevents localized indentation, as shown in Figure~\ref{fig:snowshoe_effect}.

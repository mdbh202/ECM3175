...
\begin{enumerate}
    ...
    \item \textbf{Anisotropic Composite Modelling:} Model Bamboo-HDPE as an orthotropic material with direction-dependent properties (using *MAT_002* in LS-DYNA) to assess the error introduced by the isotropic assumption in the current study.

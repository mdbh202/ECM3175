...
The project objectives establish a systematic performance evaluation of sustainable alternatives. Baseline HDPE and ABS models provide the validated reference against EN 397 experimental data required before introducing the previously unquantified response of Bamboo-HDPE and recycled Polycarbonate. Thermodynamic validation and SAE J211 signal processing address the numerical instability common in explicit FEA, ensuring that the final comparative metrics isolate structural behavior from computational noise.


\section{Scope and Assumptions}

This study evaluates the macroscopic structural deceleration and 
force transmission of construction helmet shells under normal crown 
impact (4.43~m/s) and 30$^\circ$ oblique impact conditions. To 

...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{element_ratio.png}
    \caption{Mesh element ratio distribution, confirming the dominance of high-quality quadrilaterals in the impact zone.}

...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\hsize=1.2\hsize}L C C C C C >{\hsize=0.8\hsize}L}
        \toprule
        \textbf{Material} & \textbf{E \small(GPa)} & \textbf{Yield \small(kg/mm$^2$)} & \textbf{Density \small(kg/m$^3$)} & \textbf{$\nu$} & \textbf{$E_{tan}$ \small(GPa)} & \textbf{Source} \\
        \midrule

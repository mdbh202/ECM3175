...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Peak Von Mises stress contours during top impact (EN 397). High-modulus shells (ABS, rPC) leverage higher flexural stiffness to distribute impact energy across a wider area of the EPS liner, while ductile materials (HDPE, Bamboo-HDPE) exhibit more localized stress concentrations at the impact site.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Peak Normal Stress}
        \label{fig:normal_stress_plot}
    \end{subfigure}
    \caption{Kinematic and structural response during Phase 4: (a) relative kinematic displacement (crush depth) and (b) peak normal stress histories, illustrating the distinct stiffness responses between materials.}
